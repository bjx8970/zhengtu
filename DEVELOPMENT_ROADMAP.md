...
> 最后校准：2026-09-05，基于 Phase 4 Tracking #137 验收。
> 当前版本：0.4.0-alpha.1
...
## 已完成：Phase 3 基层纵向切片（#118–#125）

- Schema 10 个人任务运行时、科员 KPI 台账、试用期与两次配置化公务员职级晋升。
- 年度考核职数 producer、乡科级副职/正职机会、270 天窗口、选拔和原子任职。
- 副职部门治理、招商→产业园政策、正式防汛链，以及两次副职任内考核。
- Phase 3 可达性门禁：正式 producer/consumer、任务前置、阶段经济、KPI producer 与自然里程碑漂移自动失败。
- Store 四年公开 dispatch 场景与 Playwright 真实 UI 自然路径均到达乡科级正职；桌面和移动端核心入口通过。

当前：Phase 4 已完成，发布基线 `0.4.0-alpha.1`。已覆盖有限 NPC 干部生命周期、动态岗位空缺、相对竞争、任职级联和周期性干部调整。

下一步：扩展县处级以上职业生态与更大范围组织模拟。
...
### Phase 3：基层纵向切片重做（已完成）

- 试用期、科员、主任科员、乡科级副职、乡科级正职
- 验证职级和领导职务双通道是否有趣
- 科员阶段管理具体任务而非多个部门

### Phase 4：NPC 和动态岗位机会（下一阶段）
