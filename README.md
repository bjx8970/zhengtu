...
当前是**本地单机优先的可玩原型**，聚焦行政线 L1-L3（科员、副科、正科）的纵向体验。玩家可以完成六步建档，在 Dashboard 查看日程并进入部门治理页安排行动、推进时间、完成 KPI 与年度考核，并通过晋升任命页选择目标职位后完成晋升流程。
...
| 职业发展 | 行政线 L1-L3，共 10 个职位配置；晋升前从候选职位中显式选择目标 |
